...
class PfGnuchains4xLm32Elf < Formula
  ...
  resource "tools" do
    url "https://github.com/PizzaFactory/homebrew-commandline/releases/download/gnuchains-tools-0.0/pf-gnuchains4x-lm32-elf-tools-4.6.4-20140428.mavericks.bottle.tar.gz"
    sha1 "1cf7a91f05db91b3b3c24b809b12a982a9236c4b"
  end
...
#      cp_r "#{version}/lm32-pizzafactory-elf", prefix
#    end
