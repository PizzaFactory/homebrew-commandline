...
class PfGnuchains4xMips64Elf < Formula
  ...
  resource "tools" do
    url "https://github.com/PizzaFactory/homebrew-commandline/releases/download/gnuchains-tools-0.0/pf-gnuchains4x-mips64-elf-tools-4.6.4-20140428.mavericks.bottle.tar.gz"
    sha1 "9b4ef078a2de6bea4e09a8c3c476e95937f9ac2f"
  end
...
#      cp_r "#{version}/mips64-pizzafactory-elf", prefix
#    end
