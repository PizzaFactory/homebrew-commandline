...
class PfGnuchains4xMipsElfTools < Formula
  ...
  bottle do
    root_url "https://github.com/PizzaFactory/homebrew-commandline/releases/download/release-gnuchains-tools-0.9"
    sha1 "4c138a835d95b2ef3ba81fc8188334f5dbb22101" => :mavericks
  end
