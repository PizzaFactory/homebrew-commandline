...
class PfGnuchains4xArmElf < Formula
  ...
  resource "tools" do
    url "https://github.com/PizzaFactory/homebrew-commandline/releases/download/gnuchains-tools-0.0/pf-gnuchains4x-arm-elf-tools-4.6.4-20140428.mavericks.bottle.tar.gz"
    sha1 "95b2ca1edd24624b7176402f84567a5ec3066fcc"
  end
...
#      cp_r "#{version}/arm-pizzafactory-elf", prefix
#    end
