...
class PfGnuchains4xAvrElf < Formula
  ...
  resource "tools" do
    url "https://github.com/PizzaFactory/homebrew-commandline/releases/download/gnuchains-tools-0.0/pf-gnuchains4x-avr-elf-tools-4.6.4-20140428.mavericks.bottle.tar.gz"
    sha1 "c72b41bda74f824a64df5bb1dc14c396993bea04"
  end
...
#      cp_r "#{version}/avr-pizzafactory-elf", prefix
#    end
