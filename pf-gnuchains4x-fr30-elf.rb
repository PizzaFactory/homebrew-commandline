...
class PfGnuchains4xFr30Elf < Formula
  ...
  bottle do
    ...
    sha1 "2d231c4e3d5b4841da2efc3cfee2a67abfae907e" => :mavericks
  end
  ...
  resource 'libs' do
    url 'https://github.com/PizzaFactory/homebrew-commandline/releases/download/release-gnuchains-libs-0.8/pf-gnuchains4x-fr30-elf-lib-4.7.4-20140603.mavericks.bottle.tar.gz'
    sha1 "d15ad5d2d644e0554d8a1aeff98d2bee319cd91d" #sha1-lib-
  end
