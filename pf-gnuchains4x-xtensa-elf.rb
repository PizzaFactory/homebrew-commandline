...
class PfGnuchains4xXtensaElf < Formula
  ...
  resource "tools" do
    url "https://github.com/PizzaFactory/homebrew-commandline/releases/download/gnuchains-tools-0.0/pf-gnuchains4x-xtensa-elf-tools-4.6.4-20140428.mavericks.bottle.tar.gz"
    sha1 "e8514c81524ab0e48fd228a5f3c1a52fd80a777e"
  end
...
#      cp_r "#{version}/xtensa-pizzafactory-elf", prefix
#    end
