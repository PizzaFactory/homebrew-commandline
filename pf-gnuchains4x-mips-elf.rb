...
class PfGnuchains4xMipsElf < Formula
  ...
  bottle do
    ...
    sha1 "159c14505a6b3776f2b1e03570a402f97ac43013" => :mavericks
  end
  ...
  resource 'libs' do
    url 'https://github.com/PizzaFactory/homebrew-commandline/releases/download/gnuchains-libs-0.0/pf-gnuchains4x-mips-elf-lib-20140428.mavericks.bottle.tar.gz'
    sha1 '14fad9d64c1e6b85805f2f157c123a6161865cda' #sha1-lib-
  end
